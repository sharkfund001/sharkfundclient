...
// Operations     
public:     
    void SetToolTip (LPCTSTR lpszToolTipText = NULL);     
    
    void SetURL(CString strURL);     
    CString GetURL()            { return m_strURL;   }     
    
    void SetColors(COLORREF crLinkColor, COLORREF crVisitedColor);     
    COLORREF GetLinkColor() { return m_crLinkColor; }     
    COLORREF GetVisitedColor()  { return m_crVisitedColor; }     
...
protected:     
    ...
    HCURSOR  m_hCursor;                         // Cursor for hyperlink     
