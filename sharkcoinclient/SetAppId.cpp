...
BOOL CSetAppId::OnInitDialog()
{
	...
	m_headText.SetWindowText(_T("设置应用ID"));
	...
	m_rBtnCancel.SetWindowText(_T("取 消")) ;
	...
	GetDlgItem(IDC_STATIC_BETID)->SetWindowText(_T("猜你妹ID:"));
	GetDlgItem(IDC_STATIC_GRBID)->SetWindowText(_T("抢红包ID"));
