...
//     
// Thanks to P? K. T?der for auto-size and window caption changes.     
//     
...
{     
    ASSERT(nCtlColor == CTLCOLOR_STATIC);     
	    ...
	    if (!(HFONT)m_Font) {           // Create font only once.
            ...
            //lf.lfUnderline = TRUE;  
			strcpy(lf.lfFaceName, "Ó×Ô²");
			lf.lfHeight = -12;
            m_Font.CreateFontIndirect(&lf);  
			*/
			m_Font.CreatePointFont(90, "Î¢ÈíÑÅºÚ");
        }     
...
void CHyperLink::SetToolTip(LPCTSTR lpszToolTipText)     
{     
    ...
    {     
        ...
        {     
            ...
            m_ToolTip.AddTool (this, lpszToolTipText);     
        }     
