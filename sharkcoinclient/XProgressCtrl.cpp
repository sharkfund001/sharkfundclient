...
IMPLEMENT_DYNAMIC(CXProgressCtrl, CProgressCtrl)  
	...
	CXProgressCtrl::CXProgressCtrl() : m_clrTextColor(RGB(255, 255, 255)),  
//	m_clrTextBkColor(RGB(128, 128, 255)),
//	m_clrTextBkColor(RGB(255, 255, 255)),  
//	m_clrBarColor(RGB(255, 255, 0)), 
	m_clrBarColor(RGB(254,153,0)),
	m_clrBarBkColor(RGB(128, 128, 255)),  
